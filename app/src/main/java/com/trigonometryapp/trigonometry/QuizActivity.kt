...
class QuizActivity : AppCompatActivity() {
    ...
    private fun displayResult() {
        ...
        startActivity(
            Intent(this, ShowResult::class.java).putIntegerArrayListExtra(
                "resultOfQuiz",
                userAnwers
            )
        )
        ...
        when (quizName) {
            ...
            "Double Triple Half" -> {
                ...
                questionsArray.add(
                    Questions(
                        "tan(3A) = ",
                        "(tan(A) - 3tan^3(A))/(1-tan²(A)",
                        "(3tan(A) + tan^3(A))/(1-3tan²(A)",
                        "(3tan(A) - tan^3(A))/(1+3tan²(A)",
                        "(3tan(A) - tan^3(A))/(1-3tan²(A)",
                        4
                    )
            ...
            "Conditional Identities" -> {
                questionsArray.add(
                    Questions(
                        ...
                        "2cos(A/2)cos(B/2)cos(C/2)",
                        "1+4cos(A/2)cos(B/2)cos(C/2)",
                        "1-4cos(A/2)cos(B/2)cos(C/2)",
                        1
                    )
                )
            ...
            "Trigonometric Equations and general values" -> {
                ...
                questionsArray.add(
                    Questions(
                        "sin^2(x) = sin^2(θ), then what is x?",
                        "2nπ +- θ",
                        "nπ - θ",
                        "nπ + θ",
                        "nπ +- θ",
                ...
                questionsArray.add(
                    Questions(
                        "cos^2(x) = cos^2(θ), then what is x?",
                        "2nπ +- θ",
                        "nπ - θ",
                        "nπ + θ",
                        "nπ +- θ",
                ...
                questionsArray.add(
                    Questions(
                        "tan^2(x) = tan^2(θ), then what is x?",
                        "2nπ +- θ",
                        "nπ - θ",
                        "nπ + θ",
                        "nπ +- θ",
            ...
            "Addition and Subtraction" -> {
                ...
                questionsArray.add(
                    Questions(
                        "cos(A+B+C) = ",
                        "cos(A)cos(B)cos(C) - cos(A)sin(B)sin(C) - sin(A)cos(B)sin(C) - cos(A)sin(B)sin(C)",
                        "cos(A)cos(B)cos(C) + cos(A)sin(B)sin(C) + sin(A)cos(B)sin(C) - cos(A)sin(B)sin(C)",
                        "cos(A)cos(B)cos(C) + cos(A)sin(B)sin(C) - sin(A)cos(B)sin(C) - cos(A)sin(B)sin(C)",
                        "cos(A)cos(B)cos(C) - cos(A)sin(B)sin(C) - sin(A)cos(B)sin(C) + cos(A)sin(B)sin(C)",
                        1
